...
Реєстрація нових студентів з вказанням особистих даних та іншої необхідної інформації;
Можливість записувати користувачів(студентів) на проходження курсів;
...
Подання рішення для завдання Виберіть опцію "10" в головному меню Введіть ID студента Виберіть курс зі списку курсів, на які записаний студент Виберіть завдання для виконання Введіть ваше рішення
